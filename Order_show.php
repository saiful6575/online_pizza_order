            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <?php
                        $getquery = "select * from get_order()";
                        ...
                        if ($result){
                            while($rowdata = pg_fetch_row($result)){
                                ...
                                <td> <?php
                                    $query = "select name from customers where id='$rowdata[1]'";

                                    $result_data = pg_query($db_handle,$query);
                                    echo pg_fetch_row($result_data)[0];
                                    ?></td>
                                <td><a href="/Pizza/Show_Pizz_Com_config.php?id=<?php echo $rowdata[2] ?>" class="btn btn-primary">composition details  <?php echo $rowdata[2]?></a></td>

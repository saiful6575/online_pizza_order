...
$res = array_key_exists('id', $_GET) ? $_GET['id']: false;
...
<head>
    ...
    <title>Pizza Composition Config</title>
        ...
        <section class="content">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Pizza Composition Config</h3>
                </div>
                <div class="box-body">
...
<!--                            </th>-->
                        ...
                        <?php
                        $getquery = $res?"select id,pizza_composition_id,ingredients_id,quantity,total_price from composition_configs where pizza_composition_id = '$res'": "select * from get_pizza_composition_config()" ;
                        ...
                        if ($result){
                            while($rowdata = pg_fetch_row($result)){
                                ...
                                <td> <?php
                                    $query = "select name from ingredients where id='$rowdata[2]'";

                                    $result_data = pg_query($db_handle,$query);
                                    echo pg_fetch_row($result_data)[0];
                                    ?></td>

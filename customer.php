...
if (isset($_POST['submit'])){
    ...
    $query = "select * from insert_customer('$customername');";
        ...
        <section class="content">
            <form action="customer.php" method="post">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" name="customername" aria-describedby="emailHelp" placeholder="Name">
                </div>

...
if (isset($_POST['submit'])){
    ...
    $query = "select * from insert_ingredients('$Name','$Provenance','$Price','$from_baker','$Stock','$Price_show');";
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form action="ingredians.php" method="post">
                <div class="form-group">
                    <label for="exampleInputEmail1">Name</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="inName" placeholder="Name">

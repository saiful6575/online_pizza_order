...
if (isset($_GET['action'])) {
    ...
    $query = "select * from delete_ingredietns('$ingredientId') ";
...
if (isset($_GET['actions'])) {
    ...
    $query = "update ingredients set is_show = $isShow where id = $id";
    pg_query($db_handle,$query);
}
        ...
        <section class="content">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Ingediants List</h3>
                </div>
                <div class="box-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <?php
                        $getquery = "select * from get_all_ingredients()";
                        ...
                        if ($result){
                            while($rowdata = pg_fetch_row($result)){
                                ?>
                                    ...
                                    <td><a href="ingrediants_update.php?id=<?php echo $rowdata[0];?>"><button type="button" class="btn btn-primary btn-sm">
                                        edit
                                    </button></a>
                                        <a href="ingrediants_show.php?id=<?php echo $rowdata[0];?>&action=delete"><button type="button" class="btn btn-primary btn-sm">
                                            Delete
                                            </button></a>

                                <?php if ($rowdata[6]=='t'){
                                    ?>
                                        <a href="ingrediants_show.php?id=<?php echo $rowdata[0];?>&actions=change&bool=false"><button type="button" class="btn btn-primary btn-sm">
                                                Hide/Show
                                            </button></a>
                                        <?php
                                    }else{?>
                                        <a href="ingrediants_show.php?id=<?php echo $rowdata[0];?>&actions=hideshow&bool=true"><button type="button" name="hideshow" class="btn btn-primary btn-sm">
                                                Hide/Show
                                            </button></a>
                                        <?php

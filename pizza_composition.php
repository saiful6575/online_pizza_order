...
if (isset($_POST['submit'])){
    ...
    $query = "select * from insert_pizza_compositions('$pizza_size');";
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form action="pizza_composition.php" method="post">
                <div class="form-group">
                        <label for="exampleFormControlSelect1">Piza Size Select</label>

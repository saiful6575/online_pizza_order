...
if (isset($_GET['action'])) {
    ...
    $supplierId = $_GET['id'];
    $query = "select * from delete_supplier('$supplierId') ";
            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <?php
                            $getquery = "select * from get_all_suppliers('ALL')";
                            ...
                            if ($result){
                                while($rowdata = pg_fetch_row($result)){
                                    ...
                                    <tr>
                                        ...
                                        <td> <span class="badge bg-light-blue"><?php if($rowdata[2]=='t'){echo 'true';}else{echo 'false';}?></span></td>
                                        <td><a href="supplier_update.php?id=<?php echo $rowdata[0];?>"><button type="button" class="btn btn-primary btn-sm">
                                                    edit
                                                </button></a></td>
                                        <td><a href="supplier_show.php?id=<?php echo $rowdata[0];?>&action=<?php echo 'delete'?>"><button type="button" name="delete" class="btn btn-primary btn-sm">
                                                    delete
                                                </button></a></td>
                                    </tr>
                        <?php

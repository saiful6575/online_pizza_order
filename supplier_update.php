...
if (isset($_POST['submit'])){
    ...
    $isshowed = $_POST['isshowed'];

    $query = "select * from update_supplier('$supplierId','$suppliername','$isshowed');";
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form action="supplier_update.php?id=<?php echo $_GET['id']?>" method="post">
                <div class="form-group">
                    <label for="exampleInputEmail1">Name</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" name="suppliername" aria-describedby="emailHelp" placeholder="Name">
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">Supplier Showed</label>
